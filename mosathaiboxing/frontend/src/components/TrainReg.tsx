...
const TrainReg: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    // Здесь вы можете отправить данные на ваш сервер
    ...
    <div className="container train_reg-container">
      ...
      <form className="train-reg-form" onSubmit={handleSubmit}>
        <div>
          ...
          <input className="input-train-reg" type="text" name="name" value={formData.name} onChange={handleChange} required />
        </div>
        <div>
          <label className="train-reg-lab">Age</label>
          <input className="input-train-reg" type="number" name="age" value={formData.age} onChange={handleChange} required />
        </div>
        <div>
          <label className="train-reg-lab">Phone Number</label>
          <input className="input-train-reg" type="tel" name="phone_number" value={formData.phone_number} onChange={handleChange} required />
        </div>
        <div>
          <label className="train-reg-lab">Email</label>
          <input className="input-train-reg" type="email" name="email" value={formData.email} onChange={handleChange} required />
        </div>
        <div>
          <label className="train-reg-lab">Parent Name</label>
          <input className="input-train-reg" type="text" name="parent_name" value={formData.parent_name} onChange={handleChange} required />
        </div>
        <div>
